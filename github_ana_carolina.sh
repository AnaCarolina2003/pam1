...
export name='Ana Carolina'
export email="ana.angotti@etec.sp.gov.br"
export repositorio="https://github.com/AnaCarolina2003/pam1.git";
...
git init
git remote add ana_carolina $repositorio
...
git push ana_carolina $branch_name